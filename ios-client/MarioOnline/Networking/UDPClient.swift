...
final class UDPClient {
    ...
    func sendProjectileState(_ projectile: ProjectileStateModel) {
        let payload = GameProtocol.packProjectileState(projectile)
        send(msgType: GameProtocol.msgProjectileState, payload: payload)
    }
