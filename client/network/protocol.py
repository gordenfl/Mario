"""UDP messaging helpers shared by the multiplayer client."""
...
def unpack_message(data: bytes) -> Tuple[int, int, int, int, bytes]:
    """Unpack a UDP message into header fields and payload."""
